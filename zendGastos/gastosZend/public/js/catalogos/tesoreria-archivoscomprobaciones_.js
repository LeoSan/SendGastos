var TesoreriaArchivoscomprobaciones = {
		init : function() {
			...
			$("#btnBuscar").click(function(e){
				...
				$('#resultadoArchivosComprobaciones').html("Cargando...");
				Layout.showLoading();
				$.ajax({
					  url: baseUrl + '/catalogos/tesoreria/archivoscomprobacione',
					  type: 'POST',
					  ...
					  success: function(data) {
						  Layout.hideLoading();
						  $('#resultadoArchivosComprobaciones').html(data);
					  } 
				});
			});
			...
			}, "#tablaArchivoComprobaciones .checkbox");

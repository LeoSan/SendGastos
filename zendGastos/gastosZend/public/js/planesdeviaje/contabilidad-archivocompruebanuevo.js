var ContabilidadGenarchivosanticipos = {
		init : function() {
			$(".grid-title").html("Generación archivos de comprobación");
			...
			$("#btnGenerarArchivo").click(function(e){
				...
				//var folio = $("#noFolio").val();
				var url = baseUrl + "/planesdeviaje/contabilidad/generararchivocomproba?userid=" + userid + "&folio=" + folio;
			...
			$("#btnGuardar").click(function(e){
				...
				$.ajax({
    		        type: "POST",
    		        dataType: 'json',
    		        url: baseUrl + '/planesdeviaje/contabilidad/setgeneraarchivoscomproba',
    		        data: {
    					idGasto	: idsGastos,
    					anticipo: anticipo,
    					userid	: userid,
